-- Plan v1.1 S5 — playbook d'approche par cible (canal, langue, angle, fenêtre,
-- personne d'entrée). Recréer la vue (c.* figé) pour l'exposer.

alter table public.cibles add column if not exists playbook jsonb;
