...
export const FICHE_SECTIONS: FicheSectionDef[] = [
  ...
  { id: "closing", titre: "Closing", num: "10", role: "chantier UX 3 du 11/09 : le rituel de fin d'épisode, avant les sources. Socle identique sur toutes les fiches (rendu par le code, jamais généré) : reminder hôte « As-tu assez creusé le comment ? » en bandeau ambre, code promo (masqué selon la catégorie de la cible), livre offert à l'humanité, toi de 18 ans, réseaux à suivre (comptes de la fiche rappelés en contrôle). Deux éléments dynamiques stockés ICI : mot (le Mot des commentaires, champ libre saisi en préparation, SEUL champ éditable inline de la fiche, exception actée au hors périmètre) ; les remerciements viennent des appuis de la cible (est_relais d'abord), jamais stockés" },
