...
export const FICHE_SECTIONS: FicheSectionDef[] = [
  ...
  { id: "chiffres", titre: "En chiffres", num: "03", role: "cartes KPI vérifiées et DATÉES (invité, société, marché), chaque carte avec sa source" },
  { id: "parcours", titre: "Parcours", num: "04", role: "dates en gras, sans point final, chaque ligne peut déclencher une question" },
  { id: "entreprise", titre: "L'entreprise / le sujet", num: "05", role: "chronologie, chiffres clés, modèle, concurrence, bascules" },
  { id: "playbook", titre: "Playbook", num: "06", role: "5-8 méthodes : ce qu'on sait, ce qui manque, la question qui l'extrait. OBLIGATOIRE" },
  ...
  { id: "sources", titre: "Sources", num: "14", role: "liens datés avec l'apport de chacun" },
